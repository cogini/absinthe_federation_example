defmodule AbsintheFederationExampleWeb do
  @moduledoc """
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {AbsintheFederationExampleWeb.Layouts, :app}
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: AbsintheFederationExampleWeb.Router,
        statics: AbsintheFederationExampleWeb.static_paths()
    end
  end
